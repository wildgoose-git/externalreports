...
Процедура ЗаполнениеШаблонаWord(ДанныеОбъекта,ДанныеИнспектора,ПечатнаяФорма)
	...
	ТаблицаВорд_2 	 = СтруктураТаблиц[СтрЗаменить("У%1","%1","3_Профессия_2")];
	...
	//3.6 Дата заключения договора
	ТаблицаВорд 	 = СтруктураТаблиц[СтрЗаменить("У%1","%1","3_ДатаЗаключенияДоговора")];
...
Процедура Тест(Команда)
	...
	Печать("ПФ_MXL_УведомлениеОПривлечении_13",ОбъектыНазначения);
